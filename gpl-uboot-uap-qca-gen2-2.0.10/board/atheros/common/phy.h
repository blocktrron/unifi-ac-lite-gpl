...
extern int ath_gmac_miiphy_read(char *devname, unsigned int phaddr, unsigned char reg, unsigned short *data);
extern int ath_gmac_miiphy_write(char *devname, unsigned int phaddr, unsigned char reg, unsigned short data);
