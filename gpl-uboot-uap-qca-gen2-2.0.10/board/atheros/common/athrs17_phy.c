...
void athrs17_vlan_config()
{
	...
	if ((phy_reg_read(0x0,0x4,0x03) & 0xffff) == 0xd034) {
		// disconnect user ports on ac-iw/pro (ar8337)
		athrs17_reg_write(S17_P2LOOKUP_CTRL_REG, 0x00140000);
		athrs17_reg_write(S17_P2VLAN_CTRL0_REG, 0x10001);

		athrs17_reg_write(S17_P3LOOKUP_CTRL_REG, 0x00140000);
		athrs17_reg_write(S17_P3VLAN_CTRL0_REG, 0x10001);
	} else {
		// ac-pro/edu/m-pro (ar8334)
