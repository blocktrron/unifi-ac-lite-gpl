...
typedef enum { BOOTP, RARP, ARP, TFTP, TFTP_SERVER, DHCP, PING, DNS, NFS, CDP, NETCONS, SNTP, ATHRHDR, RECOVERY } proto_t;
#else
typedef enum { BOOTP, RARP, ARP, TFTP, TFTP_SERVER, DHCP, PING, DNS, NFS, CDP, NETCONS, SNTP, RECOVERY } proto_t;
#endif
...
extern void     PingReply(volatile uchar * inpkt, int len);
