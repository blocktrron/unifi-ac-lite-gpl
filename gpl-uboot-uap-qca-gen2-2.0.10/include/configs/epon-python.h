...
#define MTDPARTS_SQUASHFS_8	"mtdparts=ar7240-nor0:256k(u-boot),64k(u-boot-env),1024k(kernel),6528k(rootfs),256k(cfg),64k(EEPROM)"
#define MTDPARTS_INITRAMFS_8 "mtdparts=ar7240-nor0:256k(u-boot),64k(u-boot-env),7552k(jffs2),256k(cfg),64k(EEPROM)"
#define MTDPARTS_INITRAMFS_16 "mtdparts=ar7240-nor0:256k(u-boot),64k(u-boot-env),15744k(jffs2),256k(cfg),64k(EEPROM)"
#define MTDPARTS_DEFAULT    MTDPARTS_INITRAMFS_16
...
#define CONFIG_BOOTCOMMAND "run ubntboot"
