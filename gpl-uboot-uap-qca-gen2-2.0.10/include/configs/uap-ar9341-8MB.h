...
#define EXTRA_ENV_SETTINGS_SQUASHFS         \
            "mtdparts="MTDPARTS_DEFAULT"\0"
#define CONFIG_EXTRA_ENV_SETTINGS     EXTRA_ENV_SETTINGS_SQUASHFS
...
#define	BOOTARGS_SQUASHFS       "root=31:03 rootfstype=squashfs init=/init "BOOTARGS_DEFAULT_COMMON
#define BOOTARGS_FSBOOT_DUAL    BOOTARGS_DEFAULT_COMMON

#define	CONFIG_BOOTARGS     BOOTARGS_SQUASHFS
