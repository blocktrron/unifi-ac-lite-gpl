 ...
 */
/* all layouts we suppported for 16MB flash */
#define KILOBYTES_SHIFT             10
#define UBNT_PART_BOOT_OFF          0x0

#define UBNT_PART_BOOT_SIZE         384
#define UBNT_PART_ENV_SIZE          64
#define UBNT_PART_KERNEL_SIZE       7776
#define UBNT_PART_BOOTSEL_SIZE      128
#define UBNT_PART_CFG_SIZE          256
#define UBNT_PART_EEPROM_SIZE       64
#define UBNT_PART_LINUX_KERN1_SIZE  7840  /* 7776 + 64 */
...
#define UBNT_PART_KERNEL1_OFF       (UBNT_PART_KERNEL0_OFF + UBNT_PART_KERNEL_SIZE_H)
#define UBNT_PART_BOOTSEL_OFF       (UBNT_PART_KERNEL1_OFF + UBNT_PART_KERNEL_SIZE_H)
