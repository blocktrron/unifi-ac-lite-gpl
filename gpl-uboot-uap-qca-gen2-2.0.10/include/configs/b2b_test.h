...
#ifdef CONFIG_ATH_NAND_FL
#define CONFIG_BOOTARGS     "console=ttyS0,115200 root=31:01 rootfstype=yaffs2 init=/sbin/init mtdparts=music-nand0:3072k(image),102400k(nand_yaffs2) mem=252M"
#else
#define	CONFIG_BOOTARGS     "console=ttyS0,115200 root=31:01 rootfstype=jffs2  init=/sbin/init mtdparts=music-nor0:3072k(image),6144k(spi_jffs2) mem=252M"
#endif
...
#define CONFIG_OEM_PRODUCT          "b2b_test"
...
#define CONFIG_EXTRA_ENV_SETTINGS                   \
    ...
    "up_fs31=ping ${serverip}; tftp 0x80060000 "CONFIG_OEM_PRODUCT"_spi_jffs2_linux_2.6.31_v${asdk_ver};"   \
        " erase 0xb9300000 +0x600000; cp.b 0x80060000 0xb9300000 0xa00000 \0"                              \
    "up_linux19=ping ${serverip}; tftp 0x80060000 "CONFIG_OEM_PRODUCT"_vmlinux.gz.uImage_2.6.19.7_v${asdk_ver};"   \
        "erase 0xb9100000 +0x200000; cp.b 0x80060000 0xb9100000 0x200000\0"                                    \
...
#define CONFIG_COMMANDS	(( CONFIG_CMD_DFL | CFG_CMD_DHCP | CFG_CMD_ELF | CFG_CMD_PCI |	\
	...
	CFG_CMD_FLASH | CFG_CMD_LOADS | CFG_CMD_RUN | CFG_CMD_LOADB | CFG_CMD_ELF | CFG_CMD_MDIO ))
