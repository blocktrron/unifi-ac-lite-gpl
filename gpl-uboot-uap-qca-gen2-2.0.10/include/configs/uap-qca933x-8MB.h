...
#define MTDPARTS_SQUASHFS_8	"mtdparts="MTDPARTS_DEVICE":384k(u-boot),64k(u-boot-env),1024k(kernel),6400k(rootfs),256k(cfg),64k(EEPROM)"
#define MTDPARTS_INITRAMFS_SIGNED_8	"mtdparts="MTDPARTS_DEVICE":384k(u-boot),64k(u-boot-env),7424k(kernel),256k(cfg),64k(EEPROM)"
#define MTDPARTS_FSBOOT_DUAL_8 "mtdparts="MTDPARTS_DEVICE":384k(u-boot),64k(u-boot-env),7424k(jffs2),256k(cfg),64k(EEPROM)"
#define MTDPARTS_FSBOOT_DUAL_16 "mtdparts="MTDPARTS_DEVICE":384k(u-boot),64k(u-boot-env),15616k(jffs2),256k(cfg),64k(EEPROM)"
...
#define UNIFI_FORCE_ETHACT_ETH1
//#define UNIFI_FIX_ENV
#define UBNT_FLASH_DETECT
#define RECOVERY_FWVERSION_ARCH             "qca933x"
