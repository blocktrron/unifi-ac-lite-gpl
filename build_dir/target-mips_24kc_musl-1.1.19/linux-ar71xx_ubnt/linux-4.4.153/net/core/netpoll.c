...
static void queue_cleanup(const struct sk_buff_head *list, int len)
{
	struct sk_buff *skb;
	while (skb_queue_len(list) > len) {
...
static void queue_process(struct work_struct *work)
{
	...
	queue_cleanup(&npinfo->txq, MAX_TX_QUEUED_SKBS);
